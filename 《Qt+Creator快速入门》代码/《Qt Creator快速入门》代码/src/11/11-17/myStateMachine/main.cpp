...
int main(int argc, char* argv[ ])
{
    ...
    clean->addTransition(&button1, SIGNAL(clicked()), dirty);
    dirty->addTransition(&button1, SIGNAL(clicked()), clean);
    ...
    moving->addTransition(&button2, SIGNAL(clicked()), notMoving);
    notMoving->addTransition(&button2, SIGNAL(clicked()), moving);
